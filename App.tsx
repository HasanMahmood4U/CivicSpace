...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12 font-sans">
      ...
      <footer className="fixed bottom-2 left-0 w-full text-center pointer-events-none">
        <div className="max-w-2xl mx-auto text-xs text-gray-400 pointer-events-auto">
          Developed by Hasan Mahmood
        </div>
      </footer>
    </div>
  );
